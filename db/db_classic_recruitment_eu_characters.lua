...
-- All rights reserved.
--
local provider={name=...,data=3,region="eu",date="2024-11-27T06:09:07Z",numCharacters=57,db={}}
local F
...
F = function() provider.db["Sulfuron"]={40,"Shyyz"} end F()
F = function() provider.db["Firemaw"]={42,"Bluntsy","Skruxy"} end F()
