...
-- All rights reserved.
--
local provider={name=...,data=3,region="eu",date="2024-11-30T06:08:55Z",numCharacters=64,db={}}
local F
...
F = function() provider.db["Golemagg"]={44,"Justfrosty","Justfrostydd","Justfrostydk","Justfrostydr","Justfrostyh","Justfrostypl","Shamikazze"} end F()
