...
-- All rights reserved.
--
local provider={name=...,data=3,region="eu",date="2024-10-15T06:16:28Z",numCharacters=44,db={}}
local F
...
F = function() provider.db["Golemagg"]={66,"Hypatus","Smiskey","Tovalina","Tovaliza","Zigros"} end F()
F = function() provider.db["Gehennas"]={76,"Hairypowder"} end F()
F = function() provider.db["Lakeshire"]={78,"Tâhrox"} end F()
