...
F = function() provider.db["Faerlina"]={100,"Buffsmachine","Felicy","Hancin","Krølich","Morkoll","Noturnus","Prøtøtype","Skrøldyr","Skrølz","Trukinha","Zebuzeta","Zebuzetao"} end F()
F = function() provider.db["Whitemane"]={124,"Treevort"} end F()
F = function() provider.db["Pagle"]={126,"Aynelbeyd","Hærp"} end F()
